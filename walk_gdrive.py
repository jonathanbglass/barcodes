...
def get_credentials(scopes, secrets='~/.credentials/client_secrets.json', storage='~/.credentials/drive-python-quickstart.json'):
...
for path, root, dirs, files in walk('IFTTT'):
